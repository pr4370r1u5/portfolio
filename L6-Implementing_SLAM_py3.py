...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    #Set dimension of filter, doubled for x and y
    ...
    for k in range(len(data)):
        ...
        #n is the index of the robot pose in the matirx/vector
        n=k*2
        ...
        for i in range(len(measurement)):
            ...
            for b in range(2):
                ...
                xi.value[n+b][0] += -1 * measurement[i][1+b] / measurement_noise
                xi.value[m+b][0] += measurement[i][1+b] / measurement_noise
        
        #update the information matrx/vector based on the robot motion
        for b in range(4):
            omega.value[n+b][n+b] += 1.0 / motion_noise
        for b in range(2):
            omega.value[n+b][n+b+2] += -1.0 / motion_noise
            omega.value[n+b+2][n+b] += -1.0 / motion_noise
            xi.value[n+b][0] += -1 * motion[b] / motion_noise
